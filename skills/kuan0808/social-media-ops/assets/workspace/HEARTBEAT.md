# HEARTBEAT.md — Leader Periodic Checks

_Run these during heartbeat polls. Keep it small to limit token burn._

## Every Heartbeat
- [ ] Check for stale `[PENDING APPROVAL]` items (>48h) — flag to owner
...
## Weekly (Sunday)
- [ ] Review daily memory files → update MEMORY.md
