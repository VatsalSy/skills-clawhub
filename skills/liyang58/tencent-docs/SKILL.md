...
- [工具调用示例参考](references/tool_examples.md) - 包含所有工具的完整调用示例、参数说明、返回值说明及 API 结构、枚举值说明
...
腾讯文档 MCP 的标准配置名称为 **`tencentdocs`**，支持以下两种调用方式：
...
| 工具名称 | MCP 调用格式 | 功能说明 |
|---------|-------------|---------|
| create_smartcanvas_by_markdown | `tencentdocs.create_smartcanvas_by_markdown` | ⭐ 创建智能文档（首选） |
| create_excel_by_markdown | `tencentdocs.create_excel_by_markdown` | 创建 Excel 表格 |
| create_slide_by_markdown | `tencentdocs.create_slide_by_markdown` | 创建幻灯片 |
| create_mind_by_markdown | `tencentdocs.create_mind_by_markdown` | 创建思维导图 |
| create_flowchart_by_mermaid | `tencentdocs.create_flowchart_by_mermaid` | 创建流程图 |
| create_word_by_markdown | `tencentdocs.create_word_by_markdown` | 创建 Word 文档 |
| query_space_node | `tencentdocs.query_space_node` | 查询空间节点 |
| create_space_node | `tencentdocs.create_space_node` | 创建空间节点 |
| search_space_file | `tencentdocs.search_space_file` | 搜索空间文件 |
| get_content | `tencentdocs.get_content` | 获取文档内容 |
| batch_update_sheet_range | `tencentdocs.batch_update_sheet_range` | 批量更新表格 |
| create_smartcanvas_element | `tencentdocs.create_smartcanvas_element` | 追加智能文档内容 |

**详细调用示例请参考：[工具调用示例参考](references/tool_examples.md)**
...
> 📖 所有工具的完整调用示例、参数说明和返回值说明，请查阅 [工具调用示例参考](references/tool_examples.md)
>
